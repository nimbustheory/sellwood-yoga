  ...
  return (
    <div className="pb-6">
      ...
      <section style={{ background: `linear-gradient(165deg, ${T.bg} 0%, hsl(28,22%,18%) 100%)`, color: "#fff", padding: "32px 22px", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", inset: 0, backgroundImage: `url(${STUDIO_IMAGES.heroMain})`, backgroundSize: "cover", backgroundPosition: "center", opacity: 0.105 }} />
        <div style={{ position: "absolute", inset: 0, opacity: 0.025, background: "radial-gradient(circle at 70% 20%, rgba(255,255,255,.3) 0%, transparent 60%)" }} />
